package com.janabo.myim.fragment;
...
import com.janabo.myim.adapter.EmoticionAdapter;
...
/**
 * QQ表情
 * 作者：janabo on 2017/3/17 16:04
 */
public class QqPageFragment extends BaseFaceFragment {
    ...
    private void initWidget(View rootView) {
        ...
        int total = Global.EMOTICIONS.size();
        ...
        for (int x = 0; x < pages; x++) {
            ...
            List<Emoticion> emojis = new ArrayList<>();
            emojis.addAll(Global.EMOTICIONS.subList(start, end));
            Emoticion delEmoji = new Emoticion("-1", "del_normal", "删除");
            emojis.add(delEmoji);
            EmoticionAdapter faceAdapter = new EmoticionAdapter(getActivity(), emojis, mListener);
